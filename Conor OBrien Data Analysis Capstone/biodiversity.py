...
chi2, pval_reptile_mammal, dof, expected = chi2_contingency(contingency1)
...
# AFTER USING SAMPLE SIZE CALCULATOR, NEEDED SAMPLE SIZE AT 90% CONFIDENCE IS 890

# How many weeks would you need to observe sheep at Bryce National Park in order to observe enough sheep?  How many weeks would you need to observe at Yellowstone National Park to observe enough sheep?

# In[34]:

yellowstone_weeks_observing = 890 / 507.
print(yellowstone_weeks_observing)

bryce_weeks_observing = 890 / 250.
